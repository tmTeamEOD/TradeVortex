        ...
        >
          ...
          >
            ...
            <div className="flex-1 p-6 overflow-y-auto flex flex-col space-y-4">
              ...
              {/* Response Area */}
              <div className="flex-1 bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow-inner flex flex-col">
                ...
                {loading ? (
                  ...
                  <motion.div
                    ...
                    className="prose dark:prose-dark flex-1 overflow-y-auto px-4" // 좌우 패딩 추가
                  >
                    <ReactMarkdown
