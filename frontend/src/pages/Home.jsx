...
const Home = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 to-black text-white px-4">
      ...
      <section className="relative bg-gray-900 text-white py-32 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            가장 진보되고 역동적인 금융 커뮤니티에 오신 것을 환영합니다. 여기에서는 전문가, 취미 투자자, 학습자가 함께 모여 금융의 미래를 논의하고 탐구하며 형성해 나갑니다. 경험 많은 투자자이든, 성장하는 트레이더이든, 단순히 금융 세계에 호기심이 있든, 저희 플랫폼은 탁월한 통찰력, 도구, 그리고 같은 생각을 가진 사람들과 연결될 수 있는 기회를 제공합니다.
          </motion.p>
        </div>
      </section>
